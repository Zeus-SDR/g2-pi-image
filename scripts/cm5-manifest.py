...
def main():
    ...
    filename = ("g2-saturn-trixie64-cm5-sd-2026-09-13.img.xz" if args.sd
                else "g2-saturn-trixie64-cm5-2026-09-13.img.xz")
    release = "2026.09.13-cm5-sd" if args.sd else "2026.09.13-cm5"
    ...
    entry.update(
        ...
        release_date="2026-09-13", devices=["pi5-64bit"],
